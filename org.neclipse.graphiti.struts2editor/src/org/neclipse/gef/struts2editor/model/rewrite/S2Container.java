...
public class S2Container extends S2Model implements IS2Container {
	...
	/* (non-Javadoc)
	 * @see org.neclipse.gef.struts2editor.model.rewrite.IS2Container#getChildren()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.neclipse.gef.struts2editor.model.rewrite.IS2Container#setChildren(java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.neclipse.gef.struts2editor.model.rewrite.IS2Container#addChild(org.neclipse.gef.struts2editor.model.rewrite.IS2Model)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.neclipse.gef.struts2editor.model.rewrite.IS2Container#removeChild(org.neclipse.gef.struts2editor.model.rewrite.IS2Model)
	 */
	@Override
