 ...
 *
 */
public class S2ConnectionEndpointLocator implements Locator {
	 ...
	 * @since 2.0
	 */
	public S2ConnectionEndpointLocator(Connection c, boolean isEnd) {
		end = isEnd;
		conn = c;
		uDistance = 14;
		vDistance = 4;
	...
	public void relocate(IFigure figure) {
		...
		int quadrant;
		if (connOwner != null) {
			/* Moving the Action to its absolute co-ordinates */
			Rectangle connOwnerBounds = connOwner.getBounds().getCopy();
			connOwner.getParent().translateToParent(connOwnerBounds);
